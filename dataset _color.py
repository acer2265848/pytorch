        ...
        if is_cross==False:
            ...
            for i in x.batch.unique():
                ...
                if np.all(df.status=="abnormal"):
                    path=pre_path+whole+"/"+method+"/train/abnormal/"
                else:
                    path=pre_path+whole+"/"+method+"/train/normal/"
            ...
            for i in x.batch.unique():
                ...
                lst = list()
                if np.all(df.status=="abnormal"):
                    path=pre_path+whole+"/"+method+"/validation/abnormal/"
                else:
                    path=pre_path+whole+"/"+method+"/validation/normal/"
