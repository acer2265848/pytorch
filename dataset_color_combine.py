...
class dataset_dataloader:
    def __init__ (self,pre_path,is_whole,is_cross,method,method2,cross_number_for_test=1,batch_size=24,numworkers=2):
        #pre_path = "wafer_img"
        if is_cross==False:
            import pandas as pd
            import numpy as np
...
print("combine color 1 channel Function setting done")
